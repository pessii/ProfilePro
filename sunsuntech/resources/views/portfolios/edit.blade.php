...
<form method="POST" action="{{ route('portfolio.update', ['id'=>$portfolioData->id]) }}" enctype="multipart/form-data">
    ...
    <div class="form-group mb-4">
        ...
        <input type="text" id="serbice_name" class="form-control custom-input" name="serbice_name" value="{{ old('serbice_name', $portfolioData->serbice_name) }}" required>
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <input type="text" id="site_url" class="form-control custom-input" name="site_url" value="{{ old('site_url', $portfolioData->site_url) }}">
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <textarea id="project_overview" class="form-control custom-input" name="project_overview">{{ old('project_overview', $portfolioData->project_overview) }}</textarea>
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <input type="text" id="coding" class="form-control custom-input" name="coding" value="{{ old('coding', $portfolioData->coding) }}">
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <input type="text" id="design" class="form-control custom-input" name="design" value="{{ old('design', $portfolioData->design) }}">
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <input type="text" id="responsibilities" class="form-control custom-input" name="responsibilities" value="{{ old('responsibilities', $portfolioData->responsibilities) }}">
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <textarea id="explanation" class="form-control custom-input" name="explanation">{{ old('explanation', $portfolioData->explanation) }}</textarea>
    </div>
